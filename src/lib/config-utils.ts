...
export function getApiKeyStorageKey(provider: Provider): string | null {
  switch (provider) {
    ...
    case 'anthropic': return ANTHROPIC_API_KEY_STORAGE_KEY;
    case 'google': return GOOGLE_API_KEY_STORAGE_KEY;
    case 'z-ai': return Z_AI_API_KEY_STORAGE_KEY;
    default: return null; // Custom providers use config.apiKey
  }
}
