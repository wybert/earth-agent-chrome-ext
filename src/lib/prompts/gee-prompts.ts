...
- **When using the screenshot tool, the image is automatically shown to the user. Do NOT include the image markdown or data URL in your text response. Just refer to 'the screenshot above'.**`,
};
