...
global.chrome = {
    ...
    sidePanel: { // Note: Found this missing in previous read, adding based on typical usage but sticking to original read if unsure. 
        // Wait, let's verify exact content from Step 195. 
        // Step 195 lines 57-60:
        //   sidePanel: {
        //     setOptions: jest.fn((options, cb) => cb && cb()),
        //     open: jest.fn((opts, cb) => cb && cb()),
        //   },
